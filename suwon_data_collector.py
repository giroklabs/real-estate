...
def collect_suwon_data():
    """수원시 전체 구 데이터 수집 및 저장"""
    ...
    if all_data:
        ...
        all_data_filename = f"suwon_all_data_{timestamp}.json"
        ...
        summary = {
            ...
            'total_regions': len(suwon_regions),
        ...
        summary_filename = f"suwon_collection_summary_{timestamp}.json"
